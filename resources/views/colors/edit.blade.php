@extends('layouts.app', ['title' => __('Color')])
                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                       <h6 class="heading-small text-muted mb-4">{{ __('Color information') }}</h6>
                        ...
                        @endif
                            <div class="pl-lg-4">
                            <form method="post" action="{{ route('colors.update', $color) }}" autocomplete="off" enctype="multipart/form-data">
                                    @csrf
                                    @method('put') 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Color Name') }} ..." value="{{ old('name', $color->name) }}" autofocus>
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group{{ $errors->has('code') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="code" id="code" class="form-control form-control-alternative{{ $errors->has('code') ? ' is-invalid' : '' }}" placeholder="{{ __('Image code') }} ..." value="{{ old('name', $color->code) }}" autofocus>
                                                @if ($errors->has('code'))
                                                    <span class="invalid-feedback" role="alert">
