          ...
          <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
            ...
            <li class="web-menu">
              ...
              @if(\Request::route()->getName() != "cart.checkout")
                <a  id="desCartLink" href="{{ route('view_cart') }}" class="btn btn-neutral btn-icon btn-cart" style="cursor:pointer;">
            ...
            <li class="mobile-menu">
              @if(\Request::route()->getName() != "cart.checkout")
                <a  id="mobileCartLink" href="{{ route('view_cart') }}"  class="nav-link" style="cursor:pointer;">
                    <i class="fa fa-shopping-cart"></i>
                    <span class="nav-link-inner--text">{{ __('Cart') }}</span>
                </a>
              @endif  
